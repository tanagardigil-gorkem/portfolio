          ...
          {signals.map((signal) => {
            ...
            return (
              <a
                key={signal.label}
                href={signal.href}
                className="group bg-[#0a1529]/70 border border-cyan-900/40 rounded-xl p-5 hover:border-cyan-500/60 transition-colors shadow-lg backdrop-blur-sm flex items-center gap-4"
              >
